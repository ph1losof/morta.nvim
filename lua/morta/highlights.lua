...
function M.get_highlights(colors, config)
  ...
  add_hl("Normal", { fg = colors.fg, bg = colors.bg })
  ...
  add_hl("SignColumn", { bg = colors.bg })
  ...
  add_hl("DiffAdd", { fg = colors.string, bg = colors.diff.add, bold = true })
  add_hl("DiffChange", { fg = colors.blue, bg = colors.diff.change })
  add_hl("DiffDelete", { fg = colors.red, bg = colors.diff.delete, bold = true })
  add_hl("DiffText", { fg = colors.purple, bg = colors.diff.change, bold = true })
  add_hl("diffOldFile", { fg = colors.blue, bg = colors.bg_highlight })
  add_hl("diffNewFile", { fg = colors.blue, bg = colors.bg_highlight })
  add_hl("diffFile", { fg = colors.blue })
  add_hl("diffLine", { fg = colors.comment })
  add_hl("diffIndexLine", { fg = colors.purple })
  ...
  add_hl("WinBar", { bg = colors.bg_float })
  add_hl("WinBarNC", { bg = colors.bg_float })
  ...
  add_hl("DiagnosticWarn", { fg = colors.warning, bold = true })
  ...
  add_hl("DiagnosticUnderlineWarn", { undercurl = true, sp = colors.warning })
  ...
  add_hl("DiagnosticVirtualTextWarn", { fg = colors.warning, bg = colors.bg_highlight, bold = true })
  ...
  add_hl("GitSignsAdd", { fg = colors.git_add, bold = true })
  add_hl("GitSignsChange", { fg = colors.git_change })
  add_hl("GitSignsDelete", { fg = colors.git_delete, bold = true })
